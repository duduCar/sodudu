...
@implementation SNRefreshTableView
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (_refreshDelegate && [_refreshDelegate respondsToSelector:@selector(scrollViewDidScrollWith:)]) {
        [_refreshDelegate scrollViewDidScrollWith:scrollView];
    }
}
...
-(UITableViewCellEditingStyle)tableView:(UITableView *)tableView editingStyleForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (_refreshDelegate && [_refreshDelegate respondsToSelector:@selector(refreshtableView:editingStyleForRowAtIndexPath:)]) {
